                ...
                for data, ptr, ret  in self.live_data():
                    ...
                    if ret :
                        ...
                        if globalvars.meteo_data.status == 0:
                            ...
                            globalvars.meteo_data.illuminance = float(data["illuminance"]) /127.3
                            globalvars.meteo_data.uv = float(data["uv"])
